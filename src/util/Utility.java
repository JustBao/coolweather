...
public class Utility {
	...
	public static void handleWeatherResponse(Context context,String response){
		try {
			...
			String weatherDedp=weatherInfo.getString("weather");
			String publishTime=weatherInfo.getString("ptime");
			
			saveWeatherInfo(context,cityName,weatherCode,temp1,temp2,weatherDedp,publishTime);
	...
	/**
	 * 将服务器返回的所有天气信息存储到sharedPrefences文件中
	 * @param context
	 * @param cityName
	 * @param weatherCode
	 * @param temp1
	...
	private static void saveWeatherInfo(Context context, String cityName,
			String weatherCode, String temp1, String temp2, String weatherDedp,
			String publishTime) {
		...
		editor.putString("weather_desp",weatherDedp);
